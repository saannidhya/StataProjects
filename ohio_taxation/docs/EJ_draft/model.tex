...
\begin{enumerate}
  \item \textbf{Consumption–Saving Euler Equation:} The household equalizes the marginal utility of consuming an additional unit today to the discounted utility of saving it until tomorrow. This yields:
    ...
    \end{equation}
    In other words, the marginal rate of intertemporal substitution equals the
    net discounted return on capital after depreciation. This is the standard Euler equation ensuring optimal capital accumulation.
...
\end{equation}
Given \eqref{eq:housing_clearing}, the price $p_{h,t}$ is determined by the housing Euler \eqref{eq:euler_H_cons} and the paths of $\{c_t,G_t\}$. In steady state, substituting $c_{t+1}\!=\!c_t\!=\!c$, $h_{t+1}\!=\!h_t\!=\!h\!=\!\bar H$, $G_{t+1}\!=\!G_t\!=\!G$, and $p_{h,t+1}\!=\!p_{h,t}\!=\!p_h$ into \eqref{eq:euler_H_cons} yields the user–cost formula:
...
\noindent Equation 10 still contains the marginal utility of consumption \(U_c(\cdot)\). Because the one-period utility function chosen is:
\[
