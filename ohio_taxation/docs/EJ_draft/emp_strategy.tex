...
We follow a dynamic model of RD design and estimate the {\bf Intent-to-Treat} or ITT estimator. We prefer using the ITT estimator instead of the alternative {\bf Treatment on the Treated} (TOT) estimator because the ITT estimator is more suited to our setting given the independence of the renewal elections\footnote{As described in \cite{cellini2010value}, when the elections are independent, the ITT estimator equals the TOT estimator.}.
