...
if (`obs'==30000) {
	...
	** local constant **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(0) q(1) h(0.00202285) b(0.0285847) q_pilot(0.109358) kernel(uniform)
	...
	** linear **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(1) q(2) h(0.0285847) b(0.109358) q_pilot(0.273496) kernel(uniform)
	...
	** quadratic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(2) q(3) h(0.109358) b(0.273496) q_pilot(0.588296) kernel(uniform)
	...
	** cubic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(3) q(4) h(0.273496) b(0.588296) q_pilot(1) kernel(uniform)
	...
	** quartic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(4) q(5) h(0.588296) b(1) q_pilot(1) kernel(uniform)
	...
	** local constant **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(0) q(1) h(0.00291745) b(0.0363672) q_pilot(0.13079) kernel(triangular)
	...
	** linear **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(1) q(2) h(0.0363672) b(0.13079) q_pilot(0.315328) kernel(triangular)
	...
	** quadratic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(2) q(3) h(0.13079) b(0.315328) q_pilot(0.662054) kernel(triangular)
	...
	** cubic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(3) q(4) h(0.315328) b(0.662054) q_pilot(1) kernel(triangular)
	...
	** quartic **
	...
	capture altrdcctamse_preasym_fixbw Y x, deriv(0) c(0) p(4) q(5) h(0.662054) b(1) q_pilot(1) kernel(triangular)
