...
h_tri_noreg_4=r(h_tri_noreg_4) b_tri_noreg_4=r(b_tri_noreg_4) n_tri_noreg_4=r(n_tri_noreg_4), reps(5000): RD_sim_LM_estbw, obs(`n');
#delimit cr

saveold "RD_sim_LM_rb_estbw_`n'_m`machine'_jbes.dta", replace
