...
foreach n in 500 6558 60000 {
	...
	clear all
	use "RD_sim_DL_cl_estbw_`n'_jbes.dta", clear
	...
	forvalues pol=0/4 {
		...
		* AMSE-chosen p
		...
		qui gen pfer_cl_`ker'_noreg_`pol' = min(amse_cl_`ker'_noreg_0, amse_cl_`ker'_noreg_1, amse_cl_`ker'_noreg_2, amse_cl_`ker'_noreg_3, amse_cl_`ker'_noreg_4) == amse_cl_`ker'_noreg_`pol'
		}
	}	
	...
	foreach stat in n h tau_cl devsq_cl cvr_cl lng_cl cvradj_cl lngadj_cl {
		...
		* Estimates of AMSE-chosen p
		...
		qui replace `stat'_`ker'_noreg_pf = `stat'_`ker'_noreg_0 if pfer_cl_`ker'_noreg_0 == 1
...
****************************************************************************************************************************	
	...
	di "CCT;" 0 ";" ave_h_unif_0 ";" ave_n_unif_0 ";" d_mse_cl_unif_0 ";" ///
	...
	**	
	...
	di "CCT;" 0 ";" ave_h_tri_0 ";" ave_n_tri_0 ";" d_mse_cl_tri_0 ";" ///
