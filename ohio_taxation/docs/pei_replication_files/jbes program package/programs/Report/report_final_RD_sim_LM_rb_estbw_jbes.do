...
foreach n in 500 3105 {
	...
	forvalues pol=1/4 {
		...
		* AMSE-chosen p
		...
		qui gen pfer_rb_`ker'_noreg_`pol' = min(amse_rb_`ker'_noreg_1, amse_rb_`ker'_noreg_2, amse_rb_`ker'_noreg_3, amse_rb_`ker'_noreg_4) == amse_rb_`ker'_noreg_`pol'
		}
	}	
...
****************************************************************************************************************************	
	...
	di "CCT;" 2 ";" ave_h_unif_2 ";" ave_n_unif_2 ";" d_mse_rb_unif_2 ";" ///
	...
	**	
	...
	di "CCT;" 2 ";" ave_h_tri_2 ";" ave_n_tri_2 ";" d_mse_rb_tri_2 ";" ///
