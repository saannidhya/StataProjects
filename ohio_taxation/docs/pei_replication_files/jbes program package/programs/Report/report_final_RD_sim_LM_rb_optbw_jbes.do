...
foreach n in 500 3105 {
	...
	clear all
	use "RD_sim_LM_rb_optbw_`n'_jbes.dta", clear
	...
	forvalues pol=1/4 {
		...
		* AMSE-chosen p
		qui gen pfer_rb_`ker'_`pol' = min(amse_rb_`ker'_1, amse_rb_`ker'_2, amse_rb_`ker'_3, amse_rb_`ker'_4) == amse_rb_`ker'_`pol'
		}
	}	
...
****************************************************************************************************************************	
	...
	di "Theo. Optimal;" 1 ";" ave_h_unif_1 ";" ave_n_unif_1 ";" mse_rb_unif_1 ";" ///
		ave_cvr_rb_unif_1 ";" ave_lng_rb_unif_1 ";" ave_lngadj_rb_unif_1		
		
	di ""	
	
	di "Theo. Optimal;" 2 ";" ave_h_unif_2 ";" ave_n_unif_2 ";" d_mse_rb_unif_2 ";" ///
	...
	di ";Fraction of time phat=(1,2,3,4): (" pr_pfer_rb_unif_1 ", " ///
	...
	**	
	...
	di "Theo. Optimal;" 1 ";" ave_h_tri_1 ";" ave_n_tri_1 ";" mse_rb_tri_1 ";" ///
		ave_cvr_rb_tri_1 ";" ave_lng_rb_tri_1 ";" ave_lngadj_rb_tri_1		
		
	di ""	
	
	di "Theo. Optimal;" 2 ";" ave_h_tri_2 ";" ave_n_tri_2 ";" d_mse_rb_tri_2 ";" ///
	...
	di ";Fraction of time phat=(1,2,3,4): (" pr_pfer_rb_tri_1 ", " ///
