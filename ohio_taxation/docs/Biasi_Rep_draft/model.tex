...
\begin{enumerate}
  ...
  \item \textbf{Housing demand}
    ...
    For example, with $U_h = \frac{\alpha_h A(G_t)}{h_t}$ and $U_c = \frac{1}{c_t}$, this condition gives:
    \begin{equation}
    \frac{\alpha_h A(G_t)}{h_t} = \frac{1}{c_t}q_t,
    \end{equation}
    or equivalently:
    \begin{equation}
    \alpha_h A(G_t) c_t = q_t h_t.
    \end{equation}
  ...
  \begin{equation}
    \frac{\alpha_h A(G_t)}{h_t} = \frac{(1+\tau_H)p_{h,t}}{c_t} \quad\Longrightarrow\quad p_{h,t} = \frac{\alpha_h A(G_t) c_t}{(1+\tau_H)h_t}.
  \end{equation}
