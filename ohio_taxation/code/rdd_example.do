...
*************************************************************************
use "C:/Users/rawatsa/OneDrive - University of Cincinnati/StataProjects/ohio_taxation/data/headstart.dta", clear
des
...
* trying to create variables
gen T_times_R  = T*R

reg $Y T R T_times_R if abs(R)<=9, robust
